...
class AllOrderPage(tk.Frame):
    def __init__(self, parent, ctrl: CoreApp):
        tk.Frame.__init__(self, parent)
        self.my_tabel = None
        self.ctrl = ctrl

        self.ctrl.title("All Order Page")
    ...
    def render(self, orders):
        ...
        # back button
        back_btn = tk.Button(self, command=lambda: self.ctrl.show("AdminHomePage"), text="Kembali",
